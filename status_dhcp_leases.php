...
<div class="panel panel-default">
    <div class="panel-heading">
        <h2 class="panel-title"><?=gettext('Pool Status')?></h2>
    </div>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h2 class="panel-title"><?=gettext('Leases')?></h2>
    </div>
    <div class="panel-body table-responsive">
        <table class="table table-striped table-hover table-condensed sortable-theme-bootstrap" data-sortable>
            <thead>
            ...
            <tbody id="leaselist">
                ...
                <tr>
                    ...
                    <?php else: ?>
                    <td><span class="dot offline"></span></td>
                    <?php endif; ?>
                    <!-- DHCP ONLINE OFFLINE -->
                    ...
                    <td><?=htmlspecialchars(adjust_gmt($data['start']))?></td>
                    <td><?=htmlspecialchars(adjust_gmt($data['end']))?></td>
                    <?php elseif ($data['act'] == $expired_string): ?>
                    <td><?=htmlspecialchars(adjust_gmt($data['start']))?></td>
                    <td><?=htmlspecialchars(adjust_gmt($data['end']))?></td>
                    <?php else: ?>
                    <td> </td>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h2 class="panel-title"><?=gettext('Leases in Use')?></h2>
    </div>
    <div class="panel-body table-responsive">
        <table class="table table-striped table-hover table-condensed sortable-theme-bootstrap" data-sortable>
            <thead>
